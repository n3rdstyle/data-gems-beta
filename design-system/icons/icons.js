/**
 * Icon System
 * SVG icons used throughout the design system
 * All icons are 24x24px with 2px stroke
 * Icons from Material Design Icons by Pictogrammers (Apache 2.0 License)
 */
...
const ICONS = {
  ...
  chevronUp: `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      <path d="m4.5 15.75 7.5-7.5 7.5 7.5"></path>
    </svg>
  `,
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { ICONS, getIcon, getIconNames };
}
